...
use super::feeds::NasdaqFeedKind;
...
fn nasdaq_menu(current_path: &str) -> Markup {
    let feed_meta: Vec<(&'static str, &'static str, String)> = NasdaqFeedKind::ALL
        .iter()
...
impl RenderAppPane for FeedItemListPage {
    fn render_pane(&self) -> lariv_rs::components::AppLayoutHtml {
        scaffold_pane(
            nasdaq_menu(&self.path_and_query),
...
impl RenderAppPane for FeedItemDetailPage {
    fn render_pane(&self) -> lariv_rs::components::AppLayoutHtml {
        scaffold_pane(
            nasdaq_menu(&feed_list_url(&self.feed_slug)),
